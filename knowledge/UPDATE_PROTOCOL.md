...
> 目标：让本 skill 的知识库始终同时跟上 Claude Code 和 OpenClaw 的真实能力。
...
3. 用户明确要求核对最新能力
4. OpenClaw 路由/会话/skills 相关行为发生变化
...
| 3 | 官方包/版本源 | npm / GitHub releases |
| 4 | 本机真实 smoke test | 校验 wrapper / hooks / 会话路由 |
...
- OpenClaw 消息：`openclaw message --help`
- Claude Code 官方文档：
...
3. 对 rollout / 灰度能力明确标注“账号未开通”或“待验证”
4. 对托管架构相关结论，必须至少做一次本地 smoke test
